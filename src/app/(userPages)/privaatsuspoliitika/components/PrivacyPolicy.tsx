...
export default function PrivacyPolicy() {
  return (
    <div>
      <p>
        Omare OÜ jaoks on oluline Teie privaatsus ja järgida kõiki kehtivaid
        seadusi ja määrusi mis tahes isikuandmete kohta, mida võime Teie kohta
        koguda, kui külastate meie veebilehte{" "}
        <a href="https://www.pitsakoht.ee">www.pitsakoht.ee</a>. Meie veebisaiti
      ...
      <p>Teie andmete töötleja on Omare OÜ </p>
      <p>ettevõtte reg. number: 14740077</p>
      <p>e-post: Omare.oy@outlook.com </p>
      <p>telefoninumber: +37255570761 </p>
      <p>
        Kogume ja töötleme teavet kooskõlas Euroopa Liidu üldise andmekaitse
        määrusega (GDPR), mis jõustus 25.05.2018.
      </p>
      <h2 className="text-2xl font-bold">Andmete kogumine ja kasutamine</h2>
      <h3 className="text-xl font-bold">Milliseid andmeid me kogume</h3>
      <p>
      ...
      <ul>
        <li>
          Kui teete tellimuse{" "}
          <a href="https://www.pitsakoht.ee">www.pitsakoht.ee</a> e-poes
        </li>
        <li>
          Kui registreerite end{" "}
          <a href="https://www.pitsakoht.ee">www.pitsakoht.ee</a> e-poe
          kasutajaks
        </li>
        <li>
        ...
        <li>
          ...
          <a href="https://www.pitsakoht.ee">www.pitsakoht.ee</a>
        </li>
        <li>
      ...
      <h3 className="text-xl font-bold">Kogutavad andmetüübid</h3>
      <h4 className="font-bold">Isikuandmed</h4>
      <p>
      ...
      <h4>Logifailid</h4>
      <p>
        Meie veebileht <a href="https://www.pitsakoht.ee">www.pitsakoht.ee</a>{" "}
      ...
      <h3 className="text-xl font-bold">Kuidas me andmeid kasutame</h3>
      <p>
      ...
      <h3 className="text-xl font-bold">Teie isikuandmete säilitamine</h3>
      <p>
      ...
      <h3 className="text-xl font-bold">Laste andmete töötlemine</h3>
      <p>
      ...
      <p>
        ...
        Omare.oy@outlook.com või telefonitsi: +37255570761. Teeme kõik meist
        oleneva, et parandada ebatäpset, puudulikku, eksitavat või aegunud
        teavet.
      </p>
      <p>
      ...
      <h2 className="text-2xl font-bold">GDPR andmekaitseõigused</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold">Teie andmete turvalisus</h2>
      <p>
      ...
      <p>
        Omare OÜ võtab ette kõik mõistlikult vajalikud meetmed, et tagada Teie
      ...
      <h2 className="text-2xl font-bold">Viitamine teistele veebisaitidele</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold">Privaatsuspoliitika uuendused</h2>
      <p>
      ...
      <br />
      <p>Viimati muudetud 21/02/2024</p>
      <br />
    </div>
  );
}
